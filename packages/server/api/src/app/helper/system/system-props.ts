...
export enum AppSystemProp {
    ...
    ENGINE_PLUGINS = 'ENGINE_PLUGINS',
    ENGINE_PLUGIN_HOOK_TIMEOUT_MS = 'ENGINE_PLUGIN_HOOK_TIMEOUT_MS',
    ENGINE_PLUGIN_HOOK_MAX_TIMEOUT_MS = 'ENGINE_PLUGIN_HOOK_MAX_TIMEOUT_MS',
