...
async function buildSettingsResponse(_log: FastifyBaseLogger): Promise<WorkerSettingsResponse> {
    ...
    const settings = {
        ...
        ENGINE_PLUGINS: system.getOrThrow(AppSystemProp.ENGINE_PLUGINS),
        ENGINE_PLUGIN_HOOK_TIMEOUT_MS: system.getNumberOrThrow(AppSystemProp.ENGINE_PLUGIN_HOOK_TIMEOUT_MS),
        ENGINE_PLUGIN_HOOK_MAX_TIMEOUT_MS: system.getNumberOrThrow(AppSystemProp.ENGINE_PLUGIN_HOOK_MAX_TIMEOUT_MS),
